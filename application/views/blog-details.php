            ...
            <div class="container">
                <div class="blog_details">
                    <div class="post_img">
                        ...
                        <?php } else {
                        ?>
                            <img src="<?= setImage($details[0]['image'], 'uploads/blogs/') ?>" alt="img">
                        <?php }
                        ?>
                    </div>
                    <div class="row">
                                            ...
                                            ?>
                                                    <li class="recent_post_item">
                                                        <div class="recent_post_image">
                                                            ...
                                                            <img src="<?= setImage($row['image'], 'uploads/blogs/') ?>" alt="img" class="primary_img">
                                                        </div>
                                                        <div class="recent_post_content">
                                                            <h5><a href="<?= base_url() ?>blog-details/<?= encryptId($row['blog_id']) . '/' . url_title($row['title']) ?>"><?php echo $row['title']; ?></a></h5>
